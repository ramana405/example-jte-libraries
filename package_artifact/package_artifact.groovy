...
stage("Package"){
       node{
              bat "\"${tool 'MSBuild'}\" DancingGoat.sln /T:Build;Package  /p:Configuration=Release /p:Platform=\"Any CPU\" /p:DeployOnBuild=true /p:ProductVersion=1.0.0.${env.BUILD_NUMBER}"
