...
stage('build') {
       node {
              ...
              //bat "\"${tool 'MSBuild'}\" ${params.Solution_file} /T:Clean;Build; /p:Configuration=Release /p:OutputPath=obj\\Release /p:PrecompileBeforePublish=true /p:PackageAsSingleFile=true"       
       }
  } 
echo "ending msbuild"
}
